    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 ">
          ...
          <button className="w-full mt-6  bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800" type="submit">SignIn</button>
